...
([function(t,e,n){
	...
	var i={
		create:function(t){
			...
			else e.textContent=a;return e
	
		},
		icon:function(t){
			var e=i.create("use");return e.setAttributeNS(i.XLINK_NAMESPACE,"href","#icon-"+t),i.create("svg",{class:"icon"},[e])
		},
		clear:function(t){
	...
	function(t,e,n){
		...
		var i={
			...
			SOCIAL:{PLATFORMS:{FB:{NAME:"Facebook",ICON:"facebook",URL:function(t){
								...
								},MESSAGE:"I wasted my time on BreakLock, it's pointless, don't try it.",TAGS:["breaklock"]
					},
	...
	function(t,e,n){
		"use strict";function i(t,e){
			if(!(t instanceof e)) throw new TypeError("Cannot call a class as a function")}Object.defineProperty(e,"__esModule",{value:!0});
			var a=function(){
				function t(t,e){
				...
				return a(t,[
						...
						{key:"addDot",
							value:function(t){
								...
								if(void 0!=e&&n>>0===n&&e%3-n%3==n%3-t%3&&Math.floor(e/3)-Math.floor(n/3)==Math.floor(n/3)-Math.floor(t/3)){
									var i=this.addDot(n);return this.isComplete()||(this.suite.push(t),i.push(t)),i
								}
						...
						{key:"compare",value:function(t){
							...
							for(var e=0,n=0,i=0;i<this.dotLength;i++){
								...
								for(var a=0;a<this.dotLength;a++)this.suite[a]===t.suite[i]&&n++}return[e,n-e,this.dotLength-n]
							}
						},
	...
	function(t,e,n){"use strict";function i(t,e){
		...
		var a=function(){
			...
			return n&&t(e.prototype,n),i&&t(e,i),e}}(),r=n(0),
			o=function(t){
			...
			s=function(){
				function t(){
					i(this,t),this.el=o.default.create("svg",{viewBox:"0 0 "+this.SVG_WIDTH+" "+this.SVG_WIDTH})
						}
					return a(t,[
					{key:"addBackgroundLayer",
						value:function(){
							var t=o.default.create("rect",{fill:"#fff","fill-opacity":"0",width:this.SVG_WIDTH,height:this.SVG_WIDTH});
								return this.el.appendChild(t),t
						}
					},
					{key:"addPattern",
						value:function(t){
							var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:14,n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"#fff",i=[];n=n instanceof Array?n:[n];
					...
					{key:"addDots",
						value:function(){
							var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:3,e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=[];e.fill=e.fill||"#fff";
							for(var i=0;i<9;i++)n.push(o.default.create("circle",{
								cx:i%3*this.GRID_GUTTER+this.SVG_MARGIN,cy:Math.floor(i/3)*this.GRID_GUTTER+this.SVG_MARGIN,rel:i,r:t}));
					...
					{key:"addCombinaison",
						...
						var i=t+e+n,a=Math.min(Math.floor(this.SVG_WIDTH/i),this.SVG_COMB_EXP),r=Math.floor(.75*a),s=Math.floor(.25*a),u=r+s,l=Math.floor((this.SVG_WIDTH-(i-1)*u)/2),c=this.SVG_WIDTH+Math.floor(this.SVG_COMB_EXP/2);this.el.setAttribute("viewBox","0 0 "+this.SVG_WIDTH+" "+(this.SVG_WIDTH+this.SVG_COMB_EXP));
						for(var h=[],d=0;d<i;d++)h.push(o.default.create("circle",
						{cx:l+d*u,cy:c,r:(r-this.DOT_BORDER)/2,"stroke-width":this.DOT_BORDER,fill:d<t?"#fff":"#000",stroke:d<t+e?"#fff":"#000","fill-opacity":d<t?"1":".25","stroke-opacity":d<t+e?"1":".25"}));
						return this.addGroup({},h)
						}
					},
					{key:"getSVG",value:function(){
							return this.el}}]),t}();s.prototype.SVG_NAMESPACE="http://www.w3.org/2000/svg",s.prototype.SVG_WIDTH=100,s.prototype.SVG_COMB_EXP=20,s.prototype.SVG_MARGIN=15,s.prototype.GRID_GUTTER=35,s.prototype.DOT_BORDER=2,s.prototype.DOT_MAGNET=6,e.default=s},
							function(t,e,n){
								"use strict";function i(t,e){
									var n=a(t);n&&l(n.nextFrame);var i={el:t,counter:e.length*h,originalLength:e.length,originalText:e,nextFrame:null};o(i),c.push(i)
									}
									function a(t)
									{
									...
									function r(t){
										t.nextFrame=u(function(){o(t)})}function o(t){
											
											if(t.counter-=1,t.counter<=0)return t.el.textContent=t.originalText,void a(t.el);var e=Math.floor(t.originalLength-t.counter/h);t.el.textContent=t.originalText.substr(0,e)+s(Math.min(t.originalLength-e,3)),r(t)
												}
											function s(t){
												var e="",n="abcdefghijklmnopqrstuvwxyz0123456789 _*%!?/\\|#@";
												if(t<=0)return e;for(var i=0;i<t;i++)e+=n.charAt(Math.floor(Math.random()*n.length));return e
												}
												function u(t){return window.setTimeout(t,60)}
												function l(t){return window.clearTimeout(t)}
												Object.defineProperty(e,"__esModule",{value:!0});
												var c=[],h=3;e.default=i},function(t,e,n){
													"use strict";Object.defineProperty(e,"__esModule",{value:!0});
													var i=function(t,e){
														for(var n=Math.abs(t)+"",i=t<0,a=e-n.length;a>0;a--)n="0"+n;return(i?"-":"")+n};e.default=i},
														function(t,e,n){
															"use strict";function i(t){
																return t&&t.__esModule?t:{default:t}}function a(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(e,"__esModule",{value:!0});
																var r=function(){
																	function t(t,e){
																		for(var n=0;n<e.length;n++){
																			var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)
																				...
																				return n&&t(e.prototype,n),i&&t(e,i),e}}(),o=n(16),s=i(o),u=n(12),l=i(u),c=n(13),h=i(c),d=n(17),f=i(d),p=n(2),v=i(p),y=n(3),m=i(y),E=n(1),b=i(E),g=n(0),T=i(g),k=n(19),w=i(k);n(22);
																				var C=function(){
																					function t(e){
																						a(this,t),this.statusBar=new s.default(this.abort.bind(this)),
																						this.history=new l.default,this.lock=new h.default(this.newAttempt.bind(this)),
																						this.summary=new f.default(this.action.bind(this)),this.pattern=null,this.type=null,this.isEnded=!1,this.onEnd=e,
																						...
																						return r(t,[{key:"setupTemplate",value:function(){
																							...
																							{key:"start",value:function(t,e){
																								...
																								switch(this.type=t,this.difficulty=e,this.lock.setDotLength(e),this.pattern=new v.default(e),this.pattern.fillRandomly(),this.history.clear("Connect "+e+" dots"),this.count=0,this.isEnded=!1,t){
																									...
																									{key:"newAttempt",value:function(t){
																										var e=this.pattern.compare(t),n=this.buildPatternSVG(t,e),i=e[0]===this.pattern.dotLength;if(this.count++,this.isEnded)this.statusBar.incrementCounter();
																										...
																										else switch(this.type){case b.default.GAME.TYPE.PRACTICE:this.statusBar.incrementCounter();break;case b.default.GAME.TYPE.CHALLENGE:0===this.statusBar.decrementCounter()&&(this.isEnded=!0,this.summary.setContent(!1,this.count))
																										...
																										{key:"abort",value:function(t){
																											...
																											{key:"action",value:function(t){switch(t){case b.default.GAME.ACTIONS.NEW_GAME:this.start(this.type,this.difficulty);break;case b.default.GAME.ACTIONS.BACK_HOME:this.abort();break;case b.default.GAME.ACTIONS.CONTINUE:if(!0===this.isEnded){
																												var e=this.pattern.compare(this.pattern),n=this.buildPatternSVG(this.pattern,e);this.history.stackPattern(n)}this.statusBar.setCounter(this.count)}this.summary.toggle()}
																												},{key:"buildPatternSVG",value:function(t,e){
																													var n=new m.default;n.addDots(1),n.addPattern(t,14,w.default.greydient(b.default.PATTERN.HEX_COLOR_START,b.default.PATTERN.HEX_COLOR_END,t.dotLength-3)),e&&m.default.prototype.addCombinaison.apply(n,e);
																													var i=n.getSVG();return e[0]===t.dotLength&&i.classList.add("success"),i}
																													}]),t}();e.default=C},function(t,e,n){
																														...
																														Object.defineProperty(e,"__esModule",{value:!0});
																														var r=function(){function t(t,e){for(var n=0;n<e.length;n++){
																															var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}
																															
																															}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e
																															}
																															}(),o=n(11),s=i(o),u=n(14),l=i(u),c=n(15),h=i(c),d=n(1),f=i(d),p=n(0),v=i(p),y=n(4),m=i(y);n(25);
																															var E=function(){function t(e){a(this,t),this.onStart=e,this.setupTemplate()
																															}return r(t,[{
																																key:"setupTemplate",value:function(){
																																	var t=v.default.create("h1","menu-title highlight unselectable","BreakLock"),e=v.default.create("p","menu-intro","A hybrid of Mastermind and the Android pattern lock. A game you gonna love to hate.");
																																	...
																																	{value:f.default.GAME.DIFFICULTY.HARD,label:"Hard"}]),
																																																	this.typeSelector=new h.default([{value:f.default.GAME.TYPE.PRACTICE,label:"Practice",description:"No pressure, just discover and practice your game",default:!0},
																																																	{value:f.default.GAME.TYPE.CHALLENGE,label:"Challenge",description:"Challenge mode give you 10 attempts only to win"},
																																																	{value:f.default.GAME.TYPE.COUNTDOWN,label:"Countdown",description:"Solve the game in one minute, without limit of attempts"}
																																																	]),
	...
	{key:"triggerEasterEgg",value:function(){
		...
		function(t,e,n){
			"use strict";function i(t){
				...
				var a=n(6),r=i(a),o=n(7),s=i(o);n(8);var u=document.getElementById("app-intro");u&&u.remove();var l=document.body,c=new r.default(function(){h.el.style.display="",c.el.style.display="none"
				});l.appendChild(c.el);var h=new s.default(function(t,e){c.start(t,e),h.el.style.display="none",c.el.style.display=""});h.init(),l.appendChild(h.el),c.el.style.display="none",window.scrollTo(0,0)},
				function(t,e,n){"use strict";function i(t){return t&&t.__esModule?t:{default:t}}function a(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(e,"__esModule",{value:!0});var r=function(){
				...
				return function(e,n,i){
					return n&&t(e.prototype,n),i&&t(e,i),e}}(),o=n(5),s=i(o),u=n(0),l=i(u);n(20);var c=function(){function t(){a(this,t),this.setupTemplate()}
					return r(t,[{key:"setupTemplate",value:function(){this.counterEl=l.default.create("span","countdown-counter"),this.barEl=l.default.create("span","countdown-content");
					var t=l.default.create("span","countdown-container",[this.barEl]);return this.el=l.default.create("div","countdown",[this.counterEl,t]),this.el}},
					{key:"setTimer",value:function(t,e){this.duration=t,this.remaining=t,this.endCallback=e,this.render()}},{key:"start",
					value:function(){this.interval||(this.interval=window.setInterval(this.decrement.bind(this),1e3))}},
					{key:"stop",value:function(){
						window.clearInterval(this.interval),this.interval=null}},
						{key:"decrement",value:function(){this.remaining--,this.render()}},
							...
							"use strict";function i(t,e){
								...
								var a=function(){
									function t(t,e){
										for(var n=0;n<e.length;n++){
											var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}
											return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),r=n(0),o=function(t){return t&&t.__esModule?t:{default:t}
										}(r);n(21);var s=function()
										{function t(e,n,a){i(this,t),this.title=e,this.content=n,this.isExpanded=a,this.setupTemplate()}return a(t,[{key:"setupTemplate",
										value:function(){var t=this.content instanceof String?this.content:[this.content];
										...
										{key:"init",value:function(){this.buttonEl.addEventListener("click",this.toggle.bind(this))}},{key:"toggle",
										value:function(t){
											this.isExpanded=t instanceof Boolean?t:!this.isExpanded,this.render()}},
											{key:"render",value:function(){this.el.classList[this.isExpanded?"add":"remove"]("active")}}
											]),t}();e.default=s},function(t,e,n){
												"use strict";function i(t,e){
													if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(e,"__esModule",{value:!0});
													var a=function(){
														function t(t,e){for(var n=0;n<e.length;n++){
															var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),r=n(0),o=
															function(t){return t&&t.__esModule?t:{default:t}}(r);n(23);var s=function(){function t(){i(this,t),this.lastPattern=null,this.setupTemplate()}
															return a(t,[{key:"setupTemplate",value:function(){
												...
												return r(t,[{key:"setupTemplate",value:function(){
													this.actionButtons=[];for(var t in l.default.GAME.ACTIONS){
														...
														this.actionButtons.push(e)}this.socialButtons=[];for(var n in l.default.SOCIAL.PLATFORMS){var i=f.default.create("a",{class:"summary-share-link",rel:"noopener noreferrer",target:"_blank",platform:n},[f.default.icon(l.default.SOCIAL.PLATFORMS[n].ICON)]);this.socialButtons.push(i)}
														var a=f.default.create("div","summary-feedback bloc",[f.default.create("p",{},[f.default.create("span",{},"Tweet me your feedback at "),f.default.create("a",{href:l.default.SOCIAL.PLATFORMS.TWITTER.URL("","@mxwllt",["breaklock"])},"@mxwllt")])]);
														...
														this.el=f.default.create("div","summary view",[f.default.create("div","view-bloc",[this.titleEl,this.detailsEl,this.revealEl]),f.default.create("div","view-bloc",[this.actionsEl,this.socialEl,a])]),this.el}},
													{key:"init",value:function(){var t=this;this.actionButtons.forEach(function(e){return e.addEventListener("click",t.triggerAction.bind(t))})}},
...
i=a.filter(function(t){
	return t.min<=e&&t.max>=e}).map(function(t){return t.text})):(n="Sorry, you didn't make it this time. ",i=r),n+i[Math.floor(i.length*Math.random())]
}Object.defineProperty(e,"__esModule",{value:!0});
var a=[{min:1,max:3,text:"That was pure luck, nothing else. Stop dreamin."},
...
{min:4,max:8,text:"Seems legit, with a bit of luck."},{min:7,max:10,text:"Pretty good!"},
{min:9,max:10,text:"But you made it!"},{min:11,max:50,text:"Trying random patterns is not a strategy..."},
...
function(t,e,n){
	...
	for(var i=[],a=(e-t)/n,r=0;r<=n;r++){
		var o=Math.round(t+r*a),s=o.toString(16);i.push("#"+s+s+s)
	}return i}
	};e.default=i
	},function(t,e){},
	function(t,e){},
